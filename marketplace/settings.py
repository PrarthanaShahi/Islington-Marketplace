...
SECRET_KEY = "django-insecure-&v@t49_c=rt-vhz%r(y%j@u2&e87aj(8!z%2nej4pjpmh_=(s#"
...
# Use the correct variable name STATICFILES_DIRS (plural) and ensure it's a list.
STATICFILES_DIRS = [
